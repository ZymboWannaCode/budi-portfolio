export const Icons = {
  groups: {
    ...
    class: 'h-8 w-8 shrink-0 fill-dark-400 dark:fill-dark-300',
    width: 48,
    height: 48,
  ...
  tools: {
    ...
    class:
      'mt-2 h-6 w-6 shrink-0 fill-dark-700 hs-tab-active:fill-dark-400 dark:fill-dark-300 dark:hs-tab-active:fill-dark-300 md:h-7 md:w-7',
    width: 48,
    height: 48,
    viewBox: '0 -960 960 960',
  },
  ...
  house: {
    ...
    class:
      'h-6 w-6 shrink-0 text-dark-700 hs-tab-active:text-dark-400 dark:text-dark-300 dark:hs-tab-active:text-dark-300 md:h-7 md:w-7',
    width: 24,
    height: 24,
    viewBox: '0 0 24 24',
    fill: 'none',
  ...
  arrowUp: {
    ...
    class: 'h-5 w-5 shrink-0 text-dark-400 dark:text-dark-300',
    width: 24,
    height: 24,
    viewBox: '0 0 24 24',
    fill: 'none',
    ...
    paths: [
      {
        ...
        class:
          'fill-current text-dark-500 transition duration-300 group-hover:text-red-400 dark:group-hover:text-red-400',
      },
    ],
  ...
  share: {
    ...
    class: 'h-4 w-4 group-hover:text-dark-700',
    width: 24,
    height: 24,
    viewBox: '0 0 24 24',
    fill: 'none',
  ...
  github: {
    ...
    class:
      'w-4.5 h-4.5 transition shrink-0 text-dark-700 duration-300 group-hover:-translate-y-1',
    width: 16,
    height: 16,
    viewBox: '0 0 16 16',
    fill: 'currentColor',
  ...
  accordionNotActive: {
    ...
    class:
      'block h-5 w-5 shrink-0 text-dark-600 group-hover:text-dark-500 hs-accordion-active:hidden dark:text-dark-400',
    width: 24,
    height: 24,
    viewBox: '0 0 24 24',
    fill: 'none',
  ...
  accordionActive: {
    ...
    class:
      'hidden h-5 w-5 shrink-0 text-dark-600 group-hover:text-dark-500 hs-accordion-active:block dark:text-dark-400',
    width: 24,
    height: 24,
    viewBox: '0 0 24 24',
    fill: 'none',
  ...
  xFooter: {
    ...
    class:
      'h-4 w-4 shrink-0 fill-current text-dark-700 dark:text-dark-400',
    viewBox: '0 0 24 24',
    fill: 'currentColor',
    title: 'Twitter',
  },
  ...
  quotation: {
    ...
    class:
      'absolute start-0 top-0 h-16 w-16 -translate-x-6 -translate-y-8 transform text-dark-300 dark:text-dark-700',
    width: 16,
    height: 16,
    viewBox: '0 0 16 16',
    fill: 'currentColor',
  ...
  question: {
    ...
    class: ' h-6 w-6 shrink-0 text-dark-600 dark:text-dark-400',
    viewBox: '0 0 24 24',
    fill: 'none',
    strokeWidth: '1.5',
    strokeLinecap: 'round',
